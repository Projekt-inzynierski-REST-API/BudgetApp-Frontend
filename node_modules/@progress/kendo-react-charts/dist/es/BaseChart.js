...
var BaseChart = /** @class */ (function (_super) {
    ...
    BaseChart.prototype.render = function () {
        ...
        var content = React.createElement(wrapper, {
            ...
            style: chartStyles,
            key: 'chartElement'
        }, (React.createElement("div", { onMouseLeave: this.onChartMouseLeave, ref: function (el) { return _this._element = el; }, className: "k-chart-surface" }, children)), (React.createElement(React.Fragment, null, this.showLicenseWatermark && React.createElement(WatermarkOverlay, null))));
